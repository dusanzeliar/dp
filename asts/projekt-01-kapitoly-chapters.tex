...
\label{ceg}
Základná 
Ekvivalenčné triedy predstavujú prvú úroveň abstrakcie vstupných dát  a sú základom pri vytváraní každej tabuľky.  
\section{Testovanie založené na dátach}
